        ...
        <main class="col-10 .bg-light">
            <section class="admin-cour container mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group d-flex align-items-end mt-3">
                        <div class="flex-grow-1 ms-2">
                            <input type="hidden" name="add-cour" value="add">
                            <input type="submit" class="form-control bg-dark text-white" value="Ajouter un cour">
                        </div>
                    </div>
                </form>

                <?php //une div qui affiche les erreurs de creation de cour 
                ?>
                <?php if (!empty($adminClasse->error)) : ?>
                    <div class="alert alert-danger mt-3" role="alert">
                        <?php echo $adminClasse->error; ?>
                    </div>
                <?php endif; ?>
